...
const MediaLink = (props:MediaLink) => {
  ...
  const Twitterbutton= (props: MediaLink) : JSX.Element => {
    console.log(props.twitterLink !== "");
    console.log(props.twitterLink !== undefined);
    if (props.twitterLink !== undefined && props.twitterLink !== ""){
      return (<>
          <div className="col-md-1 gap-3">
  ...
  const Facebookbutton= (props: MediaLink) : JSX.Element => {
    console.log(props.facebookLink);
    if (props.facebookLink !== undefined && props.facebookLink !== ""){
      return (<>
        <div className="col-md-1 gap-3">
  ...
  const Githubbutton= (props: MediaLink) : JSX.Element => {
    console.log(props.githubLink);
    if (props.githubLink !== undefined && props.githubLink !== ""){
      return (<>
        <div className="col-md-1 gap-3">
  ...
  const Linkedinbutton= (props: MediaLink) : JSX.Element => {
    console.log(props.linkedinLink);
    if (props.linkedinLink !== undefined && props.linkedinLink !== ""){
      return (<>
       <div className="col-md-1 gap-3">
  ...
  return (
    ...
    <Container>
      ...
      <div className="row text-center">
        ...
        <TwitterIcon
              size={"35"} // You can use rem value instead of numbers
              round
            />
        </TwitterShareButton>
        </div>
